#' @name reduction_analysis
#' @aliases reduction.analysis fecrt.analysis FECRT.analysis, fecrt, FECRT
...
#'
#' @seealso \code{\link{reduction_model}}, \code{\link{count_analysis}}, \code{\link{bayescount}}, \code{\link[runjags]{autoextend.jags}}, \code{\link[runjags]{runjags}}
...
reduction.analysis <- reduction_analysis
fecrt.analysis <- reduction_analysis
FECRT.analysis <- reduction_analysis

fecrt <- function(...){
  warning('Use of the fecrt function is deprecated and will be removed in version 1.1 - please use the reduction_analysis function instead')
